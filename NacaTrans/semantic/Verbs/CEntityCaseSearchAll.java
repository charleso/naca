 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public abstract class CEntityCaseSearchAll extends CBaseActionEntity
{
	 ...
	 * @param out
	 */
	public CEntityCaseSearchAll(int l, CObjectCatalog cat, CBaseLanguageExporter out, int nEndLine)
	{
		super(l, cat, out);
